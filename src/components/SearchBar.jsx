  ...
  <div class="relative w-full sm:max-w-2xl sm:mx-auto">
    <div class="overflow-hidden z-0 rounded-full relative p-3">
      <div class="relative flex z-50 bg-transparent rounded-full">
        ...
        <button onClick={()=> onSearch(character)} class="bg-yellow-400 rounded-full font-semibold px-8 py-2 hover:bg-yellow-200 focus:bg-yellow-600 focus:outline-none">Search</button>
      </div>
